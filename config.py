...
HOME_DIR = '/home/student/final_pat_5'  # путь к папке с проектом
LOGS = f'{HOME_DIR}/logs.txt'  # файл для логов
DB_FILE = f'{HOME_DIR}/messages.db'  # файл для базы данных


IAM_TOKEN_PATH = f'{HOME_DIR}/iam_token.json'  # файл для хранения iam_token
FOLDER_ID_PATH = f'{HOME_DIR}/folder_id.txt'  # файл для хранения folder_id
BOT_TOKEN_PATH = f'{HOME_DIR}/bot_token.txt'  # файл для хранения bot_token
